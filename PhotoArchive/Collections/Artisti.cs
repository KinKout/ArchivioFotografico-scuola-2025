...
namespace PhotoArchive.Collections
{
    ...
    /// Classe Artisti
    /// </summary>
    internal class Artisti : IEntityCollection
    {
        private List<Artista> _entities;
        private int _n_curr;
        ...
        public void Add(Artista results)
        {
            _entities.Add(results);
        }

        public Artista GetFirstEntity()
        {
            _n_curr = 0;
            return _entities[_n_curr];
        }

        public Artista? GetNextEntity()
        {
        ...
        public Artista? GetPreviousEntity()
        {
            if (_n_curr - 1 >= 0)
            {
                _n_curr--;
